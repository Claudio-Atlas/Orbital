...
class MeridianPromoV6(MovingCameraScene):
    def construct(self):
        ...
        # Build pyramid (NO timeline cost)
        pyr_data = [
            [("Pre-Algebra", "#6366F1", -2.5, -2.0),
             ("Algebra 1", "#8B5CF6", 0, -2.0),
             ("Geometry", "#A855F7", 2.5, -2.0)],
            [("Algebra 2", "#C084FC", -1.25, -0.3),
             ("Precalculus", M_TEAL, 1.25, -0.3)],
