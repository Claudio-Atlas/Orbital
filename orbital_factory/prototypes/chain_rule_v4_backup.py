"""
Why the Chain Rule Works (It's Just Multiplication) — v4
=========================================================
v3 fixes:
...
class ChainRuleV4(Scene):
    def construct(self):
        ...
        self.play(
            ...
            expr.animate.scale(0.6).move_to([0, 3.4, 0]).set_opacity(0.4),
            run_time=0.5
        )
        self.play(
        ...
        calc1.next_to(machine1[0], RIGHT, buff=0.25)
        ...
        calc2.next_to(machine2[0], RIGHT, buff=0.25)
        ...
        # Rate badge on machine
        rate1_badge = MathTex(r"\times 3", font_size=FS_KEY_FACT, color=ORANGE)
        rate1_badge_box = SurroundingRectangle(
            rate1_badge, color=ORANGE, fill_color=BOX_FILL,
            fill_opacity=0.7, buff=0.1, corner_radius=0.06, stroke_width=1.5,
        )
        rate1_badge_grp = VGroup(rate1_badge_box, rate1_badge)
        rate1_badge_grp.next_to(machine1[0], LEFT, buff=0.15)
        ...
        # Rate badge on machine 2
        rate2_badge = MathTex(r"\times 12", font_size=FS_KEY_FACT, color=CYAN)
        ...
        rate2_badge_grp.next_to(machine2[0], LEFT, buff=0.15)
        ...
        scale1_txt.next_to(machine1[0], RIGHT, buff=0.3)
        self.play(FadeIn(scale1_txt, shift=RIGHT*0.1), run_time=0.3)
        ...
        scale2_txt.next_to(machine2[0], RIGHT, buff=0.3)
        self.play(FadeIn(scale2_txt, shift=RIGHT*0.1), run_time=0.3)
        ...
        # Clear side labels
        self.play(FadeOut(scale1_txt), FadeOut(scale2_txt), run_time=0.2)
        ...
        remaining = dur - (0.6 + 0.3 + 0.4 + 0.6 + 0.15 + 0.6)
        self.wait(max(0.5, remaining))

        # ═════════════════════════════════════════════════════
        # SCENE 9: PUNCHLINE (3s + silence)
        # ═════════════════════════════════════════════════════
        dur = DUR("punchline")
