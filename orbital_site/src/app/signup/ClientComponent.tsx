      ...
      <div className={`w-full max-w-md rounded-3xl p-8 ${
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <p className={`text-xs text-center ${isDark ? "text-gray-600" : "text-gray-500"}`}>
            ...
            <Link href="/terms" className={isDark ? "text-gray-400 hover:text-gray-300" : "text-gray-700 hover:text-gray-600"}>
              Terms of Service
            </Link>{" "}
            and{" "}
            <Link href="/privacy" className={isDark ? "text-gray-400 hover:text-gray-300" : "text-gray-700 hover:text-gray-600"}>
              Privacy Policy
            </Link>
          </p>
          </>
